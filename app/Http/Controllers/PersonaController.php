...
class PersonaController extends Controller
{
    ...
    {
        $template = 'persona.administrativo.show';
        Contador::insertarRegistro($template);
        $cantidad = Contador::getCantidadTemplate($template);

        return view("persona.persona.show", ["personas" => persona::findOrFail($id), "cantidad" => $cantidad]);
    }

    public function edit($id)
    {
        $template = 'persona.persona.edit';
        Contador::insertarRegistro($template);
        $cantidad = Contador::getCantidadTemplate($template);


        return view("persona.persona.edit", ["personas" => persona::findOrFail($id), "cantidad" => $cantidad]);
